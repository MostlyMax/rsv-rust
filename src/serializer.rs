...
struct RsvRecord<'w, W: 'w + io::Write> {
    wtr: &'w mut Writer<W>,
}

impl<'a, 'w, W: io::Write> Serializer for &'a mut RsvRecord<'w, W> {
    type Ok = ();
    type Error = Error;
    ...
    fn serialize_bool(self, v: bool) -> Result<Self::Ok, Self::Error> {
        match v {
            true => self.wtr.write_field("true"),
            false => self.wtr.write_field("false"),
        }
    ...
    fn serialize_i8(self, v: i8) -> Result<Self::Ok, Self::Error> {
        self.wtr.write_field(v.to_string())
    }
